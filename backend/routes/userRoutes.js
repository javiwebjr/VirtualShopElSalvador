...
import { createUser, loginUser, logoutUser, getAllUsers, getProfile, updateProfile, deleteUser, getUser, updateUser, confirmAccount } from "../controllers/userController.js";
...
router.get('/confirmuser/:token', confirmAccount)
